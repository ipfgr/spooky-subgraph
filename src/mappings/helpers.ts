...
export function fetchTokenSymbol(tokenAddress: Address): string {
  let contract = bindToken(tokenAddress)
  let contractSymbolBytes = bindSymbolBytes(tokenAddress)
...
export function fetchTokenName(tokenAddress: Address): string {
  ...
  let contract = bindToken(tokenAddress)
  let contractNameBytes = bindNameBytes(tokenAddress)
...
function bindToken(tokenAddress: Address): ERC20 {
  return ERC20.bind(tokenAddress)
}

function bindSymbolBytes(tokenAddress: Address): ERC20SymbolBytes {
  return ERC20SymbolBytes.bind(tokenAddress)
}

function bindNameBytes(tokenAddress: Address): ERC20NameBytes {
  return ERC20NameBytes.bind(tokenAddress)
}